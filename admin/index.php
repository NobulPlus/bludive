    ...
    <div class="row" style="margin-top: 40px;">
          ...
          <div class="card darken-1">
            <div class="card-content">
              ...
              <?php if ($row['featured_image'] != ""): ?>
                <p><img src="<?= htmlspecialchars($row['featured_image'], ENT_QUOTES, 'UTF-8') ?>" height="200px" /></p>
              <?php endif; ?>
              <p>Type: <?= htmlspecialchars($row['type'], ENT_QUOTES, 'UTF-8') ?></p>
              <p>Date: <?= htmlspecialchars($date, ENT_QUOTES, 'UTF-8') ?></p>
              <p>Content: <?= htmlspecialchars(substr($content, 0, 20), ENT_QUOTES, 'UTF-8') ?>...</p>
            </div>
            <div class="card-action">
              <a href="delete.php?del=<?= $id ?>" class="waves-effect waves-light btn red darken-3">Delete</a>
              <a href="edit.php?edit=<?= $id ?>" class="waves-effect waves-light btn green darken-3">Edit</a>
            </div>
          </div>
        </div>
      <?php
      ...
      <div class="col s12 m6 l4">
        <div class="card">
          ...
          <div class="card-action">
            <a href="post.php" class="waves-effect waves-light btn blue">Create New Post</a>
          </div>
        </div>
      </div>
    </div>
