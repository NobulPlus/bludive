      ...
      <section>
        <div class="container">
          <div class="cs_portfolio_details service">
            <div class="reveal">
              <img src="assets/img/project management.jpg" class="rounded" />
            </div>
            <div class="cs_height_100 cs_height_lg_60"></div>
            <div class="anim_div_ShowDowns">
              <div class="cs_img_show_text cs_text_style_1">
                ...
                <p class="cs_text_style_body">
                  Project Management entails planning, organizing, motivating
                  and controlling resources, procedures and protocols to achieve
                  specific goals. Firms undertake projects to meet unique goals
                  and objectives. We understand how crucial your IT projects are
                  to your business processes. Hence, we will ensure a planning
                  and execution process that will meet your scope, time, quality
                  and budget specifications. We have an effective portfolio
                  management system that you can rely on. Our overall goal, at
                  Bludive Technologies, is to enable you to achieve your
                  business goals and project objectives without undue
                  constraints on your existing structures. Our team will work
                  closely with your team in the process of assessment, execution
                  and reporting.
                </p>
              </div>
            </div>
