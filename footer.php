            ...
            <div class="col-lg-6">
              <div class="style="icon-container">
                <a
                  ...
                  ><i class="fa-brands fa-linkedin fa-3x spaced-icon" style="color:white;"></i></a
                >
                <a
                  target="_blank"
                  href="https://www.instagram.com/bludivetech_/"
                  
                  ><i class="fa-brands fa-instagram fa-3x spaced-icon" style="color:white;"></i></a
                >
                <a
                  target="_blank"
                  href="https://x.com/Bludivetech"
                  
                  ><i class="fa-brands fa-x-twitter fa-3x spaced-icon" style="color: white;"></i></a
                >
              </div>
...
<!-- footer-copyright- starts-here--->
        ...
        <div class="cs_copyright text-center">
          <div class="container">Copyright &copy; 2024, All Right reserved</div>
        </div>
