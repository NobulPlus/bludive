<?php
    ...
    $page_parent = 'Support';
    $page_description = 'Have questions or need assistance? Our team is here to help. Reach out to us for inquiries, support, or feedback, and we’ll respond promptly.';
...
?>
    ...
    <div id="scrollsmoother-container">
      ...
      <section>
        <div class="container">
          ...
          <?php if ($status): echo "<h6 style=\"margin-bottom: 50px\"".$status."</h6>";
          endif; ?>
  ...
  <div class="row">
    <div class="cs_field_group col">
      <input
        ...
        required
      />
      <label for="test1" class="cs_input_label">Name</label>
    </div>
    <div class="cs_field_group col">
      <input
        class="cs_input_field"
  ...
  <div class="row">
    <div class="cs_field_group col">
      <input
        ...
        required
      />
      <label for="test3" class="cs_input_label">Phone</label>
    </div>
    <div class="cs_field_group col">
      <input
        class="cs_input_field"
        ...
        required
      />
      <label for="test4" class="cs_input_label">Subject</label>
    </div>
  </div>
  ...
  <div class="cs_field_group">
    <input
      ...
      required
    />
    <label for="test5" class="cs_input_label">Message</label>
  </div>
    ...
    >
      ...
      ></path>
            ...
            <div class="cs_contact_section_2 anim_div_ShowRightSide">
              ...
              >
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31717.306140350138!2d3.4999578978565817!3d6.437275995365511!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMjYnMTQuMiJOIDPCsDMxJzAyLjkiRQ!5e0!3m2!1sen!2s!4v1505096345489"
                  allowfullscreen=""
                ></iframe>
              </div>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="cs_icon">
                    <a href="https://www.google.com/maps" class="cs_icon_style">
                      <i>
                        <svg
                          width="14"
                          height="19"
                    ...
                    <div class="cs_icon_text">
                      <h6 class="cs_icon_title">Address</h6>
                      <p class="cs_icon_subtitle">
                        26B Adebisi Ogunniyi Crescent, Lekki Phase 1,Lagos,
                        Nigeria
                      </p>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                  <div class="cs_icon">
                    <a href="tel:+2348021810012" class="cs_icon_style">
                      <i>
                        <svg
                          width="18"
                          height="19"
                    ...
                    <div class="cs_icon_text">
                      <h6 class="cs_icon_title">Phone</h6>
                      <p class="cs_icon_subtitle">+(234) 802 1810 012</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="cs_icon">
                    <a href="mailto:info@bludive.net" class="cs_icon_style">
                      <i>
                        <svg
                          width="18"
                          height="14"
                    ...
                    <div class="cs_icon_text">
                      <h6 class="cs_icon_title">Email</h6>
                      <p class="cs_icon_subtitle">info@bludive.net</p>
                    </div>
                  </div>
                </div>
              </div>
