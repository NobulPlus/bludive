          ...
          <div class="cs_card_1_list">
            <div class="cs_card cs_style_1 anim_div_ShowDowns">
              <div class="cs_card_left">
                <div
                  class="cs_card_number cs_primary_font"
                  data-src="assets/img/hero_img_1.png"
                >
                  01
                </div>
              </div>
              ...
              <div class="cs_card_link_wrap">
                <a href="managed-and-outsourced.php" class="cs_card_link">
                  <span>
                    <svg
                      width="30"
                      height="30"
            ...
            <div class="cs_card cs_style_1 anim_div_ShowDowns">
              ...
              <div class="cs_card_link_wrap">
                <a href="technical-support.php" class="cs_card_link">
                  <span>
                    <svg
                      width="30"
                      height="30"
            ...
            <div class="cs_card cs_style_1 anim_div_ShowDowns">
              ...
              <div class="cs_card_link_wrap">
                <a href="solution-scoping-and-design.php" class="cs_card_link">
                  <span>
                    <svg
                      width="30"
                      height="30"
            ...
            <div class="cs_card cs_style_1 anim_div_ShowDowns">
              ...
              <div class="cs_card_link_wrap">
                <a href="sales-channel.php" class="cs_card_link">
                  <span>
                    <svg
                      width="30"
                      height="30"
