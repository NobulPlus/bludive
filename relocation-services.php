            ...
            <div class="anim_div_ShowDowns">
              <div class="cs_img_show_text cs_text_style_1">
                <h4 class="cs_heading_text anim_heading_title">
                  Attain safe relocation with ease
                </h4>
                <p class="cs_text_style_body">
                  A well-planned IT relocation makes the difference between
                  being fully operational and fully productive on the morning
                  after your move versus having chaos, angry customers, and
                  frustrated staff, resulting in downtime and revenue loss. We
                  can help you attain safe relocation with ease. Our bid is to
                  enable your employees able to resume operations after
                  relocation just exactly the way they were functioning the day
                  before the move. We do a detailed risk analysis to identify
                  and mitigate unexpected possibilities. Our method is based on
                  the notion that no operation is 100% fail proof. Hence, we
                  ensure detailed decommissioning, provide back-ups and have
                  well-documented fallbacks. We guarantee cost efficiency and
                  safety of vital assets
                </p>
              </div>
            </div>
          </div>
