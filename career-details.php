...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- Site Title -->
    <title><?php echo htmlspecialchars($title); ?> | BluDive Technologies Limited</title>
      ...
      <section>
        <div class="container">
          ...
          <div class="cs_slider cs_slider_3 anim_blog">
              ...
              $query = "SELECT id, title, content, featured_image FROM posts WHERE type = 'career' AND id != $blog_id";
