            ...
            <div class="anim_div_ShowDowns">
              <div class="cs_img_show_text cs_text_style_1">
                <p class="cs_text_style_body">
                  Interruptive events can happen any time, and you might have to
                  contend with a system disaster. It is critical to have a
                  comprehensive, focused, and thoroughly tested data protection
                  plan in place before crises arise.

                  <br /><br />
                  Our team can help you develop and maintain a robust plan that
                  will entail policies, tools and procedures that will enable
                  you to recover your vital infrastructure, information and
                  system software in the instance of a natural or human-induced
                  disaster.

                  <br />
                  Take advantage of our off-the-shelf backup and data protection
                  solutions to secure your data and ensure that your IT
                  infrastructure is safe.
                  <br /><br />
                  Our products range includes:<br /><br />
                  IBM system mirror<br />
                  VMware vSphere<br />
                  Microsoft Azure
                </p>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1">
              <div class="cs_footer_social">
                <a href="#" class="cs_center">Facebook</a>
                <a href="#" class="cs_center">Linkedin</a>
                <a href="#" class="cs_center">Instagram</a>
                <a href="#" class="cs_center">Twitter</a>
                <a href="#" class="cs_center">Dribbble</a>
              </div>
